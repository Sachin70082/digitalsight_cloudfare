...
async function handleArtists(request, env2, corsHeaders, currentUser) {
  const url = new URL(request.url);
  const id = url.pathname.split("/").pop();
  const getUserLabelId = /* @__PURE__ */ __name(async () => {
...
// .wrangler/tmp/bundle-8HWA0B/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-8HWA0B/middleware-loader.entry.ts
