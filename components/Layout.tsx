            ...
            <main className="flex-1 flex flex-col overflow-hidden">
                <header className="h-16 bg-gray-800 border-b border-gray-700 flex items-center justify-between px-6 gap-4">
                    ...
                    <div className="flex items-center">
                        <span className="text-white mr-3 font-medium hidden sm:inline">{user.name}</span>
                        <div className="relative">
                            <span className="inline-flex h-9 w-9 rounded-full bg-primary text-white items-center justify-center font-bold shadow-lg shadow-primary/20">
                                {user.name.charAt(0)}
                            </span>
                        </div>
                    </div>
